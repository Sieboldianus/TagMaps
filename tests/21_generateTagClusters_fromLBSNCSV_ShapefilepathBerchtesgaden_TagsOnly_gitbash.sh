...
python "D:\03_EvaVGI\05_Code\Py\standalone_tag_cluster_hdbscan\tagmaps\generateTagClusters.py" -s 'fromLBSN' -p False -o False -t True -r True -i True --ignorePlaceCorrections True --ignoreStoplists True --statisticsOnly True -f 'D:/03_EvaVGI/01_Daten/2018-02-20_NationalPark_Berchtesgarden_Nicola/nationalpark_berchtesgarden_osm.shp' 
$SHELL